  ...
  public display(index: number, level: Level): void {
    ...
    */
    if (index == 1) {
      ...
      let h: Hero = level.makeHeroAsBox(960/2, 640/2, 30, 30, "https://s3.amazonaws.com/typescript-game-studio/standard/OrangeBox.png");
      level.setCameraChase(h);
      level.setArrowKeyControls(h, 50);


      let e: Enemy = level.makeEnemyAsBox(960/2 - 80, 640/2 + 100, 30, 30, "https://s3.amazonaws.com/typescript-game-studio/standard/BlueBox.png")
